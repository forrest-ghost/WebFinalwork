...
.then(blogpost => {
    ...
    fetch(`/likesapi/${id}`, {
      ...
      .then(result => {
            ...
            likesdiv.innerHTML = `<p><img class="unlikebtn" id="unlikebtn-${id}" src="https://img.icons8.com/color/48/000000/pig.png"/> <b>${likescount+1}</b></p>`
...
function postunlikee(id,unlikedby){
    ...
    .then(bpost => {
      ...
      .then(result => {
          console.log(result);
          likesdiv = document.querySelector(`#likes-${id}`)
          likesdiv.innerHTML = `<p><img class="likebtn" id="likebtn-${id}" src="https://img.icons8.com/ios-filled/50/000000/pig.png"/> <b>${likescount-1}</b></p>`
